...
End-to-end **Vendor Performance Analysis** project using **SQL** for data exploration and extraction (joins, CTEs and aggregation), **Python** (data cleaning, detailed exploratory analysis and statistical analysis), and **Power BI** (interactive dashboards and reporting) to identify top-performing vendors, optimize inventory efficiency, and uncover actionable business insights.  
...
- **Performed EDA & Analytical Testing in Python** → Bulk Buying ≠ Guaranteed Savings(weak Correlation), high-sales vendors = generate high profit, identified underperforming brands for action, and segmented SKUs(Stock keeping unit) to reveal star vs slow-moving products for strategic inventory decisions.
...
**Dashboards:** [View Dashboard Reports](https://drive.google.com/file/d/1pZv8bHNfRPOJL2hiMTm-CN4Lc9bEUQaA/preview)
