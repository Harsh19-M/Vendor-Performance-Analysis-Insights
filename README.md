...
End-to-end **Vendor Performance Analysis** project using **SQL** for data exploration and extraction (joins, CTEs and aggregation), **Python** (EDA, data cleaning, and research analysis), and **Power BI** (interactive dashboards and reporting) to identify top-performing vendors, optimize inventory efficiency, and uncover actionable business insights.  
